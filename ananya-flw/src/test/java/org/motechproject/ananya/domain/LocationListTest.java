...
public class LocationListTest {
    ...
    public void setUp() {
        ...
        allLocations.add(new Location("D1", "B1", "P1", 1, 1, 1, null));
        allLocations.add(new Location("D1", "B1", "P2", 1, 1, 2, null));
        allLocations.add(new Location("D1", "B2", "P1", 1, 2, 1, null));
        allLocations.add(new Location("D2", "B1", "P1", 2, 1, 1, null));
        locationList = new LocationList(allLocations);
    }

    @Test
    public void shouldReturnThatLocationIsAlreadyPresentIfItIsAlreadyPresent() {
        Location currentLocation = new Location("D1", "B1", "P1", 1, 1, 1, null);
    ...
    public void shouldReturnThatLocationIsNotPresentIfItIsNotAlreadyPresent() {
        Location currentLocation = new Location("UnknownD1", "UnknownB1", "UnknownP1", 0, 0, 0, null);
    ...
    public void shouldReturnTheDistrictCodeForTheGivenLocation() {
        Location currentLocation = new Location("D1", "B1", "P2", 0, 0, 0, null);
    ...
    public void shouldReturnTheNextDistrictCodeIfTheGivenDistrictIsNotPresent() {
        Location currentLocation = new Location("D3", "B1", "P2", 0, 0, 0, null);
    ...
    public void shouldReturnTheNextBlockCodeIfTheGivenBlockIsNotPresent() {
        Location currentLocation = new Location("D1", "B3", "P2", 0, 0, 0, null);
    ...
    public void shouldReturnTheNextPanchayatCodeForTheGivenLocation() {
        Location currentLocation = new Location("D1", "B1", "P3", 0, 0, 0, null);
    ...
    public void shouldGetUniqueDistrictBlockDefaultLocation() {
        ...
        Location location1 = new Location("D1", "B1", "P1", 1, 1, 1, null);
        locations.add(location1);
        Location location1Panchayat2 = new Location("D1", "B1", "P2", 1, 1, 2, null);
        locations.add(location1Panchayat2);
        Location location2 = new Location("D1", "B2", "P3", 1, 2, 1, null);
        ...
        Location expectedFirstDefaultLocation = new Location("D1", "B1", "", 1, 1, 0, null);
        ...
        Location expectedSecondDefaultLocation = new Location("D1", "B2", "", 1, 2, 0, null);
    ...
    public void shouldNotAddADefaultLocationIfTheDefaultLocationIsAlreadyPresentInTheLocationList() {
        ...
        Location location1 = new Location("D1", "B1", "P1", 1, 1, 1, null);
        locations.add(location1);
        Location defaultLocation = new Location("D1", "B1", "", 1, 1, 0, null);
    ...
    public void shouldGetForAGivenDistrictBlockPanchayatCombination() {
        ...
        Location expectedLocation = new Location("D1", "B1", "P1", 1, 1, 1, null);
        locations.add(expectedLocation);
        locations.add(new Location("D1", "B1", "P2", 1, 1, 2, null));
        LocationList locationList = new LocationList(locations);
