...
public class OperatorServiceTest {
    ...
    public void shouldCallAllOperatorsToFetchOperator() {
        ...
        when(allOperators.findByName(operator, null)).thenReturn(new Operator(operator, 10, 0, 60000));

        Integer usage = operatorService.findMaximumUsageFor(operator, null);
    ...
    public void shouldGetTheUsageByPulseInMilliSecGivenDurationInMilliSecForAOperatorWithStartOfPulseAtZero() {
        ...
        when(allOperators.findByName(operatorName, null)).thenReturn(new Operator(operatorName, 5000000, 0, 60000));
    ...
    public void shouldGetTheUsageByPulseInMilliSecGivenDurationInMilliSecForAOperatorWithStartOfPulseBeingNonZero() {
        ...
        when(allOperators.findByName(operatorName, null)).thenReturn(new Operator(operatorName, 5000000, 500, 60500));
        Integer actualUsageByPulseInMilliSec = operatorService.usageByPulseInMilliSec(operatorName, durationInMilliSec);
    ...
    public void shouldGetTheUsageByPulseInMilliSecGivenDurationForPerSecondPulse() {
        ...
        when(allOperators.findByName(operatorName, null)).thenReturn(new Operator(operatorName, 5000000, 500, 1500));
        Integer actualUsageByPulseInMilliSec = operatorService.usageByPulseInMilliSec(operatorName, durationInMilliSec);
