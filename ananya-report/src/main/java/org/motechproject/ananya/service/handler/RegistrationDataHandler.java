...
public class RegistrationDataHandler {
    ...
    @MotechListener(subjects = {ReportPublisherService.SEND_REGISTRATION_DATA_KEY})
    ...
    @MotechListener(subjects = {ReportPublisherService.SEND_REGISTRATION_COMPLETION_DATA_KEY})
