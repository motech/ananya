...
public class CourseItemMeasureServiceTest {
    ...
    public void shouldSaveMultipleCourseItem(){
        ...
        when(allCourseItemDimensions.getOrMakeFor(contentName1, contentId1, contentType1)).thenReturn(courseItemDimension1);
        when(allCourseItemDimensions.getOrMakeFor(contentName2,contentId2,contentType2)).thenReturn(courseItemDimension2);
