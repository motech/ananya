...
public class NewCallTest {
    ...
    @Test
    public void userAsksForHelpWhenAnswerExplanationIsBeingPlayed() throws Exception {
        IVRResponse response = caller.call();
        ...
        assertTrue("If help is requested it should be played.", response.audioPlayed("003_main_menu_help"));

        assertTrue("And the help should be followed by the next question.", response.promptPlayed("0015_chapter_1_quiz_q_2"));
    }

    @Test
    public void userAsksForHelpWhenScoreIsBeingInformed() throws Exception {
        IVRResponse response = caller.call();
    ...
    @Test
    public void userAsksForHelpWhenEndOfQuizMenuIsBeingPlayed() throws Exception {
        IVRResponse response = caller.call();
        ...
        assertTrue("And the help should be followed by the chapter end option prompt.", response.promptPlayed("0029_chapter_1_end_option_prompt"));
