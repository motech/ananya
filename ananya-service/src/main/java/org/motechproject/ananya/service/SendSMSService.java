...
public class SendSMSService {
    ...
    @Autowired
    public SendSMSService(Properties smsProperties, @Qualifier("eventContext") EventContext eventContext) {
    ...
    public void buildAndSendSMS(String callerId, String locationId, Integer courseAttemptNumber) {
        ...
        String smsMessageToSend = this.smsProperties.getProperty(COURSE_COMPLETION_SMS_MESSAGE_KEY) + referenceNumber;
