...
public class CertificationCourseStateRequestTest {
    ...
    public void shouldMakeNewCertificationCourseRequestObjectFromJson() {
        ...
        CertificationCourseStateRequest certificationCourseStateRequest =
                CertificationCourseStateRequest.makeObjectFromJson(callerId, callId, dataToken, jsonString);
        ...
        assertEquals(certificationCourseStateRequest.getQuestionResponse(), "1");
