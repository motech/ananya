...
public class CertificateCourseContent {
	...
	static {
		...
		CORRECT_ANSWERS.put("Chapter 10, Question 1", "1");
		CORRECT_ANSWERS.put("Chapter 10, Question 2", "2");
		CORRECT_ANSWERS.put("Chapter 10, Question 3", "1");
		CORRECT_ANSWERS.put("Chapter 10, Question 4", "2");

		CORRECT_ANSWERS.put("Chapter 11, Question 1", "1");
		CORRECT_ANSWERS.put("Chapter 11, Question 2", "2");
		CORRECT_ANSWERS.put("Chapter 11, Question 3", "1");
		CORRECT_ANSWERS.put("Chapter 11, Question 4", "2");
	}
	...
	static {
		...
		/**
		 * Adding new chapters for UP
		 * 
		 */
		ALL_AUDIOS.add(new AudioContent("0287_ch10_l1.wav",224050));
		ALL_AUDIOS.add(new AudioContent("0288_ch10_l1_op.wav",22540));
		ALL_AUDIOS.add(new AudioContent("0289_ch10_l2.wav",190870));
		ALL_AUDIOS.add(new AudioContent("0290_ch10_l2_op.wav",21640));
		ALL_AUDIOS.add(new AudioContent("0291_ch10_l3.wav",205170));
		ALL_AUDIOS.add(new AudioContent("0292_ch10_l3_op.wav",24890));
		ALL_AUDIOS.add(new AudioContent("0293_ch10_l4.wav",145410));
		ALL_AUDIOS.add(new AudioContent("0294_ch10_l4_op.wav",48080));
		ALL_AUDIOS.add(new AudioContent("0295_ch10_qp.wav",14310));
		ALL_AUDIOS.add(new AudioContent("0296_ch10_q1.wav",35580));
		ALL_AUDIOS.add(new AudioContent("0297_ch10_q1_ca.wav",22920));
		ALL_AUDIOS.add(new AudioContent("0298_ch10_q1_wa.wav",23350));
		ALL_AUDIOS.add(new AudioContent("0299_ch10_q2.wav",46740));
		ALL_AUDIOS.add(new AudioContent("0300_ch10_q2_ca.wav",18360));
		ALL_AUDIOS.add(new AudioContent("0301_ch10_q2_wa.wav",23130));
		ALL_AUDIOS.add(new AudioContent("0302_ch10_q3.wav",45830));
		ALL_AUDIOS.add(new AudioContent("0303_ch10_q3_ca.wav",17510));
		ALL_AUDIOS.add(new AudioContent("0304_ch10_q3_wa.wav",18680));
		ALL_AUDIOS.add(new AudioContent("0305_ch10_q4.wav",46210));
		ALL_AUDIOS.add(new AudioContent("0306_ch10_q4_ca.wav",18170));
		ALL_AUDIOS.add(new AudioContent("0307_ch10_q4_wa.wav",20670));
		ALL_AUDIOS.add(new AudioContent("0308_ch10_4_ca.wav",23320));
		ALL_AUDIOS.add(new AudioContent("0309_ch10_3_ca.wav",23830));
		ALL_AUDIOS.add(new AudioContent("0310_ch10_2_ca.wav",20060));
		ALL_AUDIOS.add(new AudioContent("0311_ch10_1_ca.wav",21500));
		ALL_AUDIOS.add(new AudioContent("0312_ch10_0_ca.wav",22570));
		ALL_AUDIOS.add(new AudioContent("0313_ch10_end_op.wav",25370));
		ALL_AUDIOS.add(new AudioContent("0314_ch11_l1.wav",207050));
		ALL_AUDIOS.add(new AudioContent("0315_ch11_l1_op.wav",23060));
		ALL_AUDIOS.add(new AudioContent("0316_ch11_l2.wav",219500));
		ALL_AUDIOS.add(new AudioContent("0317_ch11_l2_op.wav",21190));
		ALL_AUDIOS.add(new AudioContent("0318_ch11_l3.wav",181740));
		ALL_AUDIOS.add(new AudioContent("0319_ch11_l3_op.wav",21650));
		ALL_AUDIOS.add(new AudioContent("0320_ch11_l4.wav",184760));
		ALL_AUDIOS.add(new AudioContent("0321_ch11_l4_op.wav",51340));
		ALL_AUDIOS.add(new AudioContent("0322_ch11_qp.wav",14920));
		ALL_AUDIOS.add(new AudioContent("0323_ch11_q1.wav",34300));
		ALL_AUDIOS.add(new AudioContent("0324_ch11_q1_ca.wav",17390));
		ALL_AUDIOS.add(new AudioContent("0325_ch11_q1_wa.wav",20300));
		ALL_AUDIOS.add(new AudioContent("0326_ch11_q2.wav",41910));
		ALL_AUDIOS.add(new AudioContent("0327_ch11_q2_ca.wav",21540));
		ALL_AUDIOS.add(new AudioContent("0328_ch11_q2_wa.wav",23280));
		ALL_AUDIOS.add(new AudioContent("0329_ch11_q3.wav",44980));
		ALL_AUDIOS.add(new AudioContent("0330_ch11_q3_ca.wav",18150));
		ALL_AUDIOS.add(new AudioContent("0331_ch11_q3_wa.wav",21060));
		ALL_AUDIOS.add(new AudioContent("0332_ch11_q4.wav",42920));
		ALL_AUDIOS.add(new AudioContent("0333_ch11_q4_ca.wav",19240));
		ALL_AUDIOS.add(new AudioContent("0334_ch11_q4_wa.wav",21760));
		ALL_AUDIOS.add(new AudioContent("0335_ch11_4_ca.wav",23920));
		ALL_AUDIOS.add(new AudioContent("0336_ch11_3_ca.wav",24220));
		ALL_AUDIOS.add(new AudioContent("0337_ch11_2_ca.wav",21660));
		ALL_AUDIOS.add(new AudioContent("0338_ch11_1_ca.wav",21110));
		ALL_AUDIOS.add(new AudioContent("0339_ch11_0_ca.wav",22930));
		ALL_AUDIOS.add(new AudioContent("0340_ch11_end_op.wav",16130));
		ALL_AUDIOS.add(new AudioContent("0341_final_score_37.wav", 5920));
		ALL_AUDIOS.add(new AudioContent("0342_final_score_38.wav", 5540));
		ALL_AUDIOS.add(new AudioContent("0343_final_score_39.wav", 5860));
		ALL_AUDIOS.add(new AudioContent("0344_final_score_40.wav", 5700));
		ALL_AUDIOS.add(new AudioContent("0345_final_score_41.wav", 5660));
		ALL_AUDIOS.add(new AudioContent("0346_final_score_42.wav", 6040));
		ALL_AUDIOS.add(new AudioContent("0347_final_score_43.wav", 5840));
		ALL_AUDIOS.add(new AudioContent("0348_final_score_44.wav", 5960));
	}
}
