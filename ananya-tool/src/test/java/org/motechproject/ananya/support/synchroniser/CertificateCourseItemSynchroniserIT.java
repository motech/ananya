...
public class CertificateCourseItemSynchroniserIT {
    ...
    public void shouldMigrateCallDurationDataFromTransactionDBToReportDB() {
        ...
        FrontLineWorkerDimension frontLineWorkerDimension = allFrontLineWorkerDimensions.getOrMakeFor(Long.valueOf(callerId), "airtel", "name", Designation.ANM.name(), RegistrationStatus.PARTIALLY_REGISTERED.toString());
