describe("Landing Controller", function () {
    ...
    it("should return jobaid enter URL", function() {
         ...
         expect(controller.jobAidEnterURL()).toEqual("v1.1/vxml/jobaid/enter.vxml")
    });
    ...
    it("should return certificate enter URL", function() {
         ...
         expect(controller.certificateEnterURL()).toEqual("v1.2/vxml/certificatecourse/enter.vxml")
    });
