...
public class CertificationCourseLogFlowTest extends SpringIntegrationTest {
    ...
    public void shouldSendSMSWhenAtPlayCourseResult() throws IOException {
        String msisdn = "9986500110" + System.currentTimeMillis();
        FrontLineWorker flw = new FrontLineWorker(msisdn, Designation.ANGANWADI, "S001B012", null).status(RegistrationStatus.REGISTERED);
