...
public class JobAidSeed {
    ...
    private Node createJobAidTree() {
        Node course = courseNode("JobAidCourse", "Playback_Leave_Balance.wav?audio=0002_select_level.wav");
        Node level1 = levelNode("level 1", "1", "Playback_Leave_Balance.wav?audio=0003_select_chapter_1.1.wav");
...
//        Node level4 = levelNode("level 4", "4", "0006_select_chapter_1.4.wav");
        ...
        Node level1Chap1 = chapterNode("Level 1 Chapter 1", "1", "Playback_Leave_Balance.wav?audio=0007_lessons_1.1.1.wav", "Playback_Leave_Balance.wav?audio=0008_select_lesson_1.1.1.wav");
        Node level1Chap2 = chapterNode("Level 1 Chapter 2", "2", "Playback_Leave_Balance.wav?audio=0009_lessons_1.1.2.wav", "Playback_Leave_Balance.wav?audio=0010_select_lesson_1.1.2.wav");
        Node level1Chap3 = chapterNode("Level 1 Chapter 3", "3", "Playback_Leave_Balance.wav?audio=0011_lessons_1.1.3.wav", "Playback_Leave_Balance.wav?audio=0012_select_lesson_1.1.3.wav");
        Node level1Chap4 = chapterNode("Level 1 Chapter 4", "4", "Playback_Leave_Balance.wav?audio=0013_lessons_1.1.4.wav", "Playback_Leave_Balance.wav?audio=0014_select_lesson_1.1.4.wav");
...
//            level4.addChild(level);
        ...
        addLessonsToChapter(level1Chap1, new String[][]{{"5771111","Playback_Leave_Balance.wav?audio=0001_prep_for_child_birth"}, {"5771112","Playback_Leave_Balance.wav?audio=0002_ifa_and_tt"}, {"5771113","Playback_Leave_Balance.wav?audio=0003_planning"}, {"5771114","Playback_Leave_Balance.wav?audio=0004_planning_and_saving"}} );
        addLessonsToChapter(level1Chap2, new String[][]{{"5771121","Playback_Leave_Balance.wav?audio=0005_inst_delivery"}, {"5771122","Playback_Leave_Balance.wav?audio=0006_six_cleans"}, {"5771123","Playback_Leave_Balance.wav?audio=0007_emereg_for_mother"}} );
        addLessonsToChapter(level1Chap3, new String[][]{{"5771124","Playback_Leave_Balance.wav?audio=0008_handling_newborn"}, {"5771131","Playback_Leave_Balance.wav?audio=0009_cord_care"}, {"5771132","Playback_Leave_Balance.wav?audio=0010_thermal_care"}, {"5771133","Playback_Leave_Balance.wav?audio=0011_early_initiation_bf"}} );
        addLessonsToChapter(level1Chap4, new String[][]{{"5771151","Playback_Leave_Balance.wav?audio=0017_need_fp"}, {"5771152","Playback_Leave_Balance.wav?audio=0018_spacing_and_y"}, {"5771153","Playback_Leave_Balance.wav?audio=0019_limiting_and_y"}, {"5771154","Playback_Leave_Balance.wav?audio=0020_options_ppfp"}} );
